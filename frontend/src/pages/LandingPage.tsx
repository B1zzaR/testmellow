...
const features = [
  ...
  },
  {
    ...
    desc: 'Фиксированные тарифы. Нет автопродления, нет скрытых платежей.',
  },
  {
    icon: 'smartphone' as const,
    title: 'До 6 устройств',
    desc: 'Базовый лимит — 4 устройства. Можно расширить до 6 за ЯД или рубли на время действия подписки.',
  },
  {
    icon: 'message' as const,
    title: 'Telegram-бот',
    desc: 'Покупка, продление, баланс и реферальная программа — всё прямо в Telegram через @mellowpn_bot.',
  },
]
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-slate-400">
            Реальные функции. Без маркетинговой воды.
          </p>
        </div>
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-2xl border border-surface-700 bg-surface-900 p-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-400">
              Один активный конфиг на подписку. Базовый лимит — 4 устройства, можно расширить до 6 на платных
              тарифах. Сервис не гарантирует обход всех блокировок
...
const faqs = [
  ...
  {
    q: 'Что такое ЯД?',
    a: 'ЯД — внутренняя валюта сервиса. Начисляется за рефералы (15% от платежа) и за покупку подписок.',
  },
  {
  ...
  },
  {
    ...
    a: 'СБП и основные российские банковские карты через платёжный агрегатор.',
  },
  {
    q: 'Сколько устройств можно подключить?',
    a: 'По умолчанию 4 устройства на одну подписку. На платных тарифах можно расширить лимит до 6 устройств за ЯД или рубли. Расширение действует до конца текущей подписки. На пробном периоде расширение недоступно.',
  },
]
